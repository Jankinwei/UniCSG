...
style_ref = "./test_style.jpg"
prompt = 'Transform the image into 3D Chibi style. The style of the image is the same as in Image 1.'
...
# reference‑guided edit_image=[content, style]
image = pipe(
    prompt,
    edit_image=images,
    seed=123,
...
out_path = os.path.join(save_dir, f'{prefix}_reference_result.png')
image.save(out_path)
